...
## CONFIRMATORY
### Positive Offsets - Model Fit & Hypotheses
```{r}
...
### Generating the Psychometric Curves
```{r}
...
exp1.predictions.plot = ggplot(pos.off.predictions.df, 
  ...
  # colors
  scale_colour_manual(values = c('#4E4E4E','#F7D027')) +
  scale_fill_manual(values = c('#4E4E4E','#F7D027')) +
  # scales
